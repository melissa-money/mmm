...
// Resource page for adding a manager to Google Business Profile
export default function GBPManagerAccess() {
  const [copied, setCopied] = useState(false);
  const email = 'melissa@millennialmoneymarketing.com';
  ...
  const steps = [
    {
      ...
      linkText: 'Go to business.google.com'
    },
    {
      title: 'Open Settings Menu',
      description: 'Click the 3 vertical dots icon (usually located near the top right of your business profile dashboard).',
      icon: MoreVertical,
    },
    {
      title: 'Select Business Profile Settings',
      description: 'From the dropdown menu, click on "Business Profile settings".',
      icon: Settings,
    },
    {
      title: 'Go to People and Access',
      description: 'Click on "People and access", then on the next screen click "Add".',
      icon: Users,
    },
    {
      title: 'Enter Email Address',
      description: 'Type the email address below:',
      icon: Mail,
      isEmailStep: true,
    },
    {
      title: 'Send Invitation',
      description: 'Click "Invite" and you\'re done! Once we accept your invitation, Google will notify you via email.',
      icon: CheckCircle,
    },
  ];
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="font-heading text-3xl sm:text-5xl md:text-6xl font-bold text-black leading-tight mb-6">
                How to Add a <span className="bg-secondary px-2 inline-block">Manager</span> on Google Business Profile
              </h1>

              <p className="text-lg sm:text-xl text-gray-700 mb-8 font-sans max-w-2xl mx-auto">
                Follow this simple guide to grant us access to manage your Google Business Profile safely and securely.
              </p>
            </div>
          </div>
        </section>
